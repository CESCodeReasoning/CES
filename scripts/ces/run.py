...
def main(dataset, pl, model_id, cache_dir, write_dir, direct, no_nl):
    ...
    for d in tqdm(os.listdir(dataset_path)):
        # if d != "HumanEval_2": continue
        # if d not in while_loops: continue
        # if dataset == 'huamneval':
        #     if '__' not in d:
        #         continue
        ...
        # print(meta_data_condition)
        
        # if not meta_data_loop and not meta_data_condition and not meta_data_branch:
        #     continue

        # if meta_data_loop or meta_data_condition:
        #     continue
